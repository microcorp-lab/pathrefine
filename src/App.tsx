...
function App() {
  ...
  return (
    <>
      <Routes>
        <Route path="/" element={<LandingPage onGetStarted={() => navigate('/editor')} />} />
...
function EditorView() {
  ...
  }, [handleExport, undo, redo, toggleHelp, toggleHeatmap, toggleCodePanel, showHelp, svgDocument, selectedPathIds, setSVGDocument, deletePath, setTool]);
