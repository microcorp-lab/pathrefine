...
export function organicSmoothPath(path: any): any {
  if (import.meta.env.DEV) console.warn('organicSmoothPath is a PRO feature. Visit https://pathrefine.dev/ to upgrade.');
  return path;
}
...
export function autoRefinePath(path: any, _intensity?: any): any {
  if (import.meta.env.DEV) console.warn('autoRefinePath is a PRO feature. Visit https://pathrefine.dev/ to upgrade.');
  return path;
}
